            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm dark:text-gray-300 text-gray-700 mb-2">Nom Agence <span className="text-red-400">*</span></label>
                    <input name="NomAgence" value={form.NomAgence} onChange={handleChange} maxLength={100} placeholder="Ex: Agence Casablanca Centre" className="w-full px-4 py-3 rounded-lg dark:bg-white/10 bg-white/80 border dark:border-white/20 border-gray-300 dark:text-white text-gray-900" required />
                  </div>
                  <div className="md:col-span-2">
                    <label className="block text-sm dark:text-gray-300 text-gray-700 mb-2">Adresse</label>
                    <input name="Adresse" value={form.Adresse} onChange={handleChange} maxLength={200} placeholder="Ex: 123 Avenue principale" className="w-full px-4 py-3 rounded-lg dark:bg-white/10 bg-white/80 border dark:border-white/20 border-gray-300 dark:text-white text-gray-900" />
                  </div>
                  <div>
                    <label className="block text-sm dark:text-gray-300 text-gray-700 mb-2">Commune</label>
                    <input name="Commune" value={form.Commune} onChange={handleChange} maxLength={60} placeholder="Ex: Casablanca" className="w-full px-4 py-3 rounded-lg dark:bg-white/10 bg-white/80 border dark:border-white/20 border-gray-300 dark:text-white text-gray-900" />
                  </div>
                  <div>
              ...
              <div className="border-t border-white/10 dark:border-white/10 border-gray-200/50 pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input type="email" name="Email" value={form.Email} onChange={handleChange} maxLength={100} placeholder="Ex: contact@agence.ma" className="w-full px-4 py-3 rounded-lg dark:bg-white/10 bg-white/80 border dark:border-white/20 border-gray-300 dark:text-white text-gray-900" />
                  </div>
                </div>
              </div>
            </div>
